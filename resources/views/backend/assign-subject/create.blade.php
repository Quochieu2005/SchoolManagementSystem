...
<div class="container-fluid px-4">
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal" method="POST" action="{{ route('cpanel.assign.subject.store') }}" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="col-md-6">
                                <select name="class_id" class="form-control" required>
                                    ...
                                    @foreach ($schoolClass as $sc)
                                        <option value="{{ $sc->id }}" {{ old('class_id') == $sc->id ? 'selected' : '' }}>
                                            {{ $sc->name }}
                                        </option>
                                    @endforeach
                                </select>
