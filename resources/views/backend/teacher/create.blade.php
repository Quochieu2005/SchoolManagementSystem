    ...
    <div class="page-content-wrap">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('cpanel.teacher.store') }}"
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group @error('qualification') has-error @enderror">
                                ...
                                <div class="col-md-6">
                                    <textarea name="qualification" class="form-control" rows="3">{{ old('qualification') }}</textarea>
                                    @error('qualification')
                                        <span class="help-block">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="slug" id="slug" class="form-control"
                                            value="{{ old('slug') }}" placeholder="tu-dong-theo-teacher-name">
                                    </div>
