        ...
        <div class="d-flex justify-content-between align-items-center mb-5">
            <div>
                <nav class="mb-0" style="--bs-breadcrumb-divider: '›';">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('cpanel.dashboard') }}"
                                class="text-decoration-none">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('cpanel.teacher') }}" class="text-decoration-none">Giáo
                                viên</a></li>
                        ...
                        <div class="alert alert-light border mt-4 mb-0" role="alert">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <small class="text-muted">Mỗi giáo viên có thể được phân công nhiều lớp và môn học khác
                                        nhau.</small>
                                </div>
                            </div>
                        </div>
